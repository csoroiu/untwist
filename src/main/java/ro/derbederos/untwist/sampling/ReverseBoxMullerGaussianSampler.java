...
public class ReverseBoxMullerGaussianSampler extends BoxMullerGaussianSampler {
     ...
     */
    public ReverseBoxMullerGaussianSampler(ReverseUniformRandomProvider rng, double mean, double standardDeviation) {
