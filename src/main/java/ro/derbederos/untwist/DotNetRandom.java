 ...
 * </ul>
 */
public class DotNetRandom implements ReverseUniformRandomProvider {
     ...
     * <p>
     * <font color="red">This violates the contract of {@link UniformRandomProvider#nextInt()}.</font>
     *
     ...
     * @see UniformRandomProvider#nextInt()
     */
    @Override
    public int nextInt() {
     ...
     * Returns a non-negative random integer.
     * <p>
     * <font color="red">This violates the contract of {@link ReverseUniformRandomProvider#prevInt()}</font>
     *
     * @return A 32-bit signed integer that is greater than or equal to {@code 0}
     * and less than {@code System.Int32.MaxValue (Integer.MAX_VALUE)}.
     * @see UniformRandomProvider#nextInt()
     * @see ReverseUniformRandomProvider#prevInt()
     */
    @Override
    public int prevInt() {
