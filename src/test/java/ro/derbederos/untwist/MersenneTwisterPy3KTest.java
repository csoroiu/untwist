...
public class MersenneTwisterPy3KTest {
    ...
    private MersenneTwisterPy3k r;

    @Before
    public void setup() {
        r = new MersenneTwisterPy3k(1234567890);
    }
    ...
    public void testSetSeedArray() {
        ...
        int[] actual = ArrayUtils.generateIntArray(expected.length, () -> r.nextInt(1000));
    ...
    public void testSet64bitSeedLongVsArray() {
        ...
        r.setSeed(seedLong);
        int[] actualLong = ArrayUtils.generateIntArray(expected.length, () -> r.nextInt(1000));

        r.setSeed(seedArray);
        int[] actualArray = ArrayUtils.generateIntArray(expected.length, () -> r.nextInt(1000));
    ...
    public void testNextInt_IntMaxValue() {
        ...
        int[] actual = ArrayUtils.generateIntArray(expected.length, () -> r.nextInt(Integer.MAX_VALUE));
    ...
    public void testNextLong_IntMaxValue() {
        ...
        long[] actual = ArrayUtils.generateLongArray(expected.length, () -> r.nextLong(Integer.MAX_VALUE));
        assertThat(actual, equalTo(expected));
    }
    ...
    public void testNextLong_LongMaxValue() {
        ...
        final long[] actual = ArrayUtils.generateLongArray(expected.length, () -> r.nextLong(Long.MAX_VALUE));
    ...
    public void testNextLong_32bit() {
        ...
        long[] actual = ArrayUtils.generateLongArray(expected.length, () -> r.nextLong(_32bit));
    ...
    public void testNextLong_16() {
        ...
        long[] actual = ArrayUtils.generateLongArray(expected.length, () -> r.nextLong(16));
    ...
    public void testNextBytes_asLongArray() {
        ...
        long[] actual = ArrayUtils.generateLongArray(expected.length, () -> {
            r.nextBytes(b);
